...
export var EmployeeCreatedEvent;
(function (EmployeeCreatedEvent) {
    const schema = z.object({
        email: z.string(),
        given_name: z.string(),
        family_name: z.string(),
        currentAgencyId: z.string()
    });
    const envelopeSchema = z.object({
        type: z.literal("employee-created"),
        data: schema,
        timestamp: z.number(),
        source: z.string(),
        id: z.string(),
...
export var EmployeeDeletedEvent;
(function (EmployeeDeletedEvent) {
    ...
    const envelopeSchema = z.object({
        type: z.literal("employee-deleted"),
        data: schema,
        timestamp: z.number(),
        source: z.string(),
        id: z.string(),
...
export var InspectorCreatedEvent;
(function (InspectorCreatedEvent) {
    ...
    const envelopeSchema = z.object({
        type: z.literal("inspector-created"),
        data: schema,
        timestamp: z.number(),
        source: z.string(),
        id: z.string(),
...
})(InspectorCreatedEvent || (InspectorCreatedEvent = {}));
export var InspectorDeletedEvent;
(function (InspectorDeletedEvent) {
    ...
    const envelopeSchema = z.object({
        type: z.literal("inspector-deleted"),
        data: schema,
        timestamp: z.number(),
        source: z.string(),
        id: z.string(),
...
})(InspectorDeletedEvent || (InspectorDeletedEvent = {}));
