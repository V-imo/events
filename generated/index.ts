...
export namespace EmployeeCreatedEvent {
  const schema = z.object({
    email: z.string(),
    given_name: z.string(),
...
export namespace EmployeeDeletedEvent {
  const schema = z.object({
    employeeId: z.string(),
    currentAgencyId: z.string()
  })
...
export namespace InspectorCreatedEvent {
  const schema = z.object({
    email: z.string(),
    given_name: z.string(),
    family_name: z.string(),
...
export namespace InspectorDeletedEvent {
  const schema = z.object({
    inspectorId: z.string(),
    currentAgencyId: z.string()
  })
